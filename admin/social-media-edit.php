                ...
                <form action="code.php" method="POST">
                    ...
                    ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" value="<?= $socialMedia['data']['name'] ?>" class="form-control" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3 text-end">
                                <button type="submit" name="updateSocialMedia" class="btn btn-primary ">Update Social Media</button>
                            </div>
                    <?php
                        } else {
